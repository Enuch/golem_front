                        ...
                        <div className="card-body">
                            ...
                            <form id="formAuthentication" className="mb-3" action="index.html" method="POST">
                                <div className="mb-3">
                                    ...
                                    <input type="text" className="form-control" id="email" name="email-username" placeholder="Lucas" autoFocus={true} />
                                </div>
                                ...
                                <div className="mb-3">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" htmlFor="remember-me"> Lembre-me </label>
                                    </div>
                                </div>
                                <div className="mb-3">
